...
@endif
<h1> Tous les chefs fillieres </h1>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="addForm" action="{{ action('ChefFilliereController@store') }}" method="POST">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/admin-cheffillieres" method="POST" id="editForm" >
...
<div   id="deleteModal" class="modal fade">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <form action="/admin-cheffillieres" id="deleteForm" method="POST" >
      <div class="modal-body">
        {{ csrf_field() }}
        {{ method_field('delete') }}
 ...
 <div class="table-scrollable">
  <table id="datatable" class="table table-striped table-bordered table-hover table-checkable order-column valign-middle">
                      ...
                      $('#email').val(data[5]);
                      $('#usertype').val(data[6]);
                      $('#editForm').attr('action', '/admin-cheffillieres/'+data[0]);
                      ...
                      //$('#id').val(data[0]);
                       ...
                       $('#deleteForm').attr('action', '/admin-cheffillieres/'+data[0]);
