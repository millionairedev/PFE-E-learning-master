...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="addForm" action="{{ action('ProfesseurController@store') }}" method="POST">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/admin-professeurs" method="POST" id="editForm" >
...
<div   id="deleteModal" class="modal fade">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <form action="/admin-professeurs" id="deleteForm" method="POST" >
      <div class="modal-body">
        {{ csrf_field() }}
        {{ method_field('delete') }}
 ...
 <div class="table-scrollable">
  <table id="datatable" class="table table-striped table-bordered table-hover table-checkable order-column valign-middle">
                      ...
                      $('#email').val(data[5]);
                      $('#usertype').val(data[6]);
                      $('#editForm').attr('action', '/admin-professeurs/'+data[0]);
                      ...
                      //$('#id').val(data[0]);
                       ...
                       $('#deleteForm').attr('action', '/admin-professeurs/'+data[0]);
