...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="addForm" action="{{ action('FiliereController@store') }}" method="POST">
...
<div   id="deleteModal" class="modal fade">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <input type="hidden" name="id" id="delete_id">
        ...
        <p>Etes-vous sûr de vouloir supprimer définitivement cette Filiere ?</p>
      </div>
      <div class="modal-footer">
 ...
 <div class="table-scrollable">
  <table id="datatable" class="table table-striped table-bordered table-hover table-checkable order-column valign-middle">
                      ...
                      $('#editForm').attr('action', '/admin-filieres/'+data[0]);
                      ...
                      //$('#id').val(data[0]);
                       ...
                       $('#deleteForm').attr('action', '/admin-filieres/'+data[0]);
