    ...
    <tbody>
        <tr>
            <td width="100">
                ...
                height="80" 
                src=
                "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQNWg8aq5hChoCz9nK2p4smiq1VZlKbZZNX3A&usqp=CAU"
...
width="580">
    <tbody>
        <tr>
            <td>
                ...
                "https://www.dur.ac.uk/images/english.studies/Homepage_Slideshow/banner-30844-pgcommunity1.jpg"
                style=
    ...
    "font-family:'Open Sans',arial,sans-serif!important;font-size:16px!important;line-height:30px!important;font-weight:400!important;color:#7e8890!important">
      Nous vous informant que professeur a ajouté un nouveau <a href="http://pfe.test"><u>travail à faire</u></a> a votre filliere </b> . 
   pour plus d'informations veuillez cliquer sur le button ci dessous. 
Salutations, </b> . 
</td>
                </tr>
            </tbody>
            ...
            <tbody>
                <tr>
                    ...
                    valign="top">
                        ...
                        "http://pfe.test/"
                        style=
                        "background-color:#11B4FE;padding:14px 28px 14px 28px;border-radius:3px;line-height:18px!important;letter-spacing:0.125em;text-transform:uppercase;font-size:13px;font-family:'Open Sans',Arial,sans-serif;font-weight:400;color:#ffffff;text-decoration:none;display:inline-block;line-height:18px!important"
                        target=
                        "_blank">Entrer</a>
    ...
    <tbody>
        ...
        <tr>
            <td align="center">
                ...
                ""
                style=
                "font-family:Open Sans,sans-serif!important;font-size:12px!important;color:blue!important;text-decoration:underline!important"
                target="_blank">FSJES </a>
            </td>
        </tr>
        <tr style=
        "padding:0;margin:0;font-size:0;line-height:0">
