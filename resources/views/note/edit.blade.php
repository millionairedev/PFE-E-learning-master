...
@section('category')
    ...
    @endsection
@section('heading',"Modifier Notes")
@section('content')
...
<div class="row">
<div class="well">
	<form enctype='multipart/form-data' class="form-vertical" action="{{route('note.update',$note->id)}}" method="post" role="form" id="create-note-form">
		{{csrf_field()}}
		{{method_field('put')}}	
	<div class="form-group">
		<label for="titre">Titre</label>
		<input type="text" name="titre" class="form-control" id="" placeholeder="Input..." value="{{$note->titre}}">	</div>
