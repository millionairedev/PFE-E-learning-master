...
<div class="row">
<div class="well">
	<form enctype='multipart/form-data' class="form-vertical" action="{{route('td.update',$td->id)}}" method="post" role="form" id="create-td-form">
		{{csrf_field()}}
		{{method_field('put')}}	
	<div class="form-group">
		<label for="titre">Titre</label>
		<input type="text" name="titre" class="form-control" id="" placeholeder="Input..." value="{{$td->titre}}">	</div>
